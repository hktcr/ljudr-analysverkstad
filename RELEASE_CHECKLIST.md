# Releasechecklista för 1.0.0-rc.11

Status: offentlig valideringskandidat. Inte produktionsverifierad 1.0.

## Förverifiering 15 augusti 2026

- [x] Fixerad testsuite: 110 av 110 tester, inventering SHA-256 `2aeb040fe73afa86b736f9f532b2e2b60d288896faf59efb3c240d866cef56b2`.
...
- [x] Syntaxkontroll och `git diff --check` godkända för rc.11.
...
- [x] Versionen `1.0.0-rc.11` är konsekvent i paket, app, workers, projekt, rapport, dokumentation, PWA-cache och validation-manifest.
- [x] Syntaxkontroll, hela fixerade testsuiten med 110 av 110 och `git diff --check` passerar.
- [x] EBU 68/68 och ITU 19/19 är oförändrad valideringsbas; rc.11 ändrar inte loudness- eller True Peak-beräkningen.
...
- [ ] Liveversionen på `https://hktcr.github.io/ljudr-analysverkstad/` visar `1.0.0-rc.11` och matchar releasecommitten.
...
- Fixerad testsuite: `110/110`, inventory SHA-256 `2aeb040fe73afa86b736f9f532b2e2b60d288896faf59efb3c240d866cef56b2`
- EBU/ITU: `68/68 respektive 19/19`
- Validation-manifest SHA-256: `99e8eade051544de1ec39cd674fe507bec7b7bbfdfefe2154e13901f4e37c714`
